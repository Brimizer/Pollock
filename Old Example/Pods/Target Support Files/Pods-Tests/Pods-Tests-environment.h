...
// Pollock
#define COCOAPODS_POD_AVAILABLE_Pollock
#define COCOAPODS_VERSION_MAJOR_Pollock 0
#define COCOAPODS_VERSION_MINOR_Pollock 1
#define COCOAPODS_VERSION_PATCH_Pollock 0
